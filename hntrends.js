(function () {
    var paper,data,xTo,xFrom,txtunderline,tooltipbg,
    paperW=1e3,paperH=500,gTLX=50,gTLY=10,gWidth=450,gHeight=450,
    timeInPx=gWidth/285,sortedStories=[],lines={},links={},tooltipMinW=300,tooltiplabels=[];
